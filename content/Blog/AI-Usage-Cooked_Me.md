+++
date = 2025-11-03T01:14:54-08:00
draft = false
title = 'Using AI cooked me, Here is what I am trying to do to fix it.'
weight = 10
[params]
...
End of uni was approaching, I started applying to jobs, I got invited to an interview, and got asked your most typical interview questions: [Two Sum](https://leetcode.com/problems/two-sum/), [Sorted Two Sum](https://leetcode.com/problems/two-sum-ii-input-array-is-sorted/description/), [K most occuring elements](https://neetcode.io/problems/top-k-elements-in-list?list=neetcode150), etc ...
...
I managed to get a bit better, and by some miracle landed a job at [wafeq](https://www.wafeq.com/en).
...
1. Ask it to explain a portion of code, or write documentation for it, then I read the code again on my own and try to understand it.
2. Use it to give me examples of usage of a certain pattern, or component, my senior calls this 'using AI as a *glorified grepper*'
3. make suggestions on how to approach a task, implement it, but not fully, use it a tool to bounce ideas off of.
...
Implementation wise, I aim to go about leetcoding again, and websites like [Project Euler](https://projecteuler.net/).
...
{{< typeit 
  ...
  lifeLike=true
>}}
Don't use Glorified Greppers to do your job.
{{< /typeit >}}